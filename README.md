...
2. From the root of the repo, run `npx serve -p 3000` to start a local server (e.g., `npx serve -p 3000` will serve the project at `http://localhost:3000/` if port 3000 is available). The following steps will assume port 3000 is used.
